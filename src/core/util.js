...
define(function (require, exports, module) {
	...
	T.remove = function (key) { if (this.containsKey(key)) { var item = this.entry[key]; this.entry[key] = null; if (delete this.entry[key]) { this.size--; } return item; } else return null; }
	...
	T.clear = function () { this.size = 0; for(var p in this.entry){ delete this.entry[p];} this.entry = new Object(); }
	...
	exports.getDocumentPosition = function(target){
	...
	exports.setDefault = function(options,defOptions){
		options = options || {};
		if (defOptions) {
			for (var prop in defOptions) {
